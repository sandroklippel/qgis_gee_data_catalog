...
larger than 0.5 ha and forest cover over 10%.''',
        'bandcombinations': {'Forest/Non-Forest landcover classification':{
                                ...
                                'qml':'palsar_fnf'}},
        'namefield': 'system:id',
        'availability': ['2015-01-01', '2017-01-02'],
...
See Simard et al. (2011) for details.''',
    ...
    'MAPBIOMAS':{
        ...
        'description': '''MapBiomas Project - Collection 4.1 of the Annual Land Use Land Cover Maps of Brazil.
...
#     'Secondary forest age for Brazil':{
#         'id': 'users/celsohlsj/public/secondary_forest_age_collection41_v2',
#         'description': '''Silva Junior et al. Benchmark maps of 33 years of 
#         secondary forest age for Brazil. Scientific Data (2020). 
#         https://doi.org/10.1038/s41597-020-00600-4.''',
#         'bandcombinations':{'Classification 1986':{
#                                 'bands': ['classification_1986'],
#                                 'scale': 30,
#                                 'suffix':'_1986',
#                                 'max':255,
